    ...
    <div className="flex flex-col items-start w-full relative">
      ...
      <div className="left-3n ">
        ...
        <svg
          ...
          stroke="currentColor"
        >
          <rect x="3" y="13" width="3" height="8" rx="1" fill="#bbf7d0" stroke="currentColor" strokeWidth="1.5"/>
          <rect x="9" y="9" width="3" height="12" rx="1" fill="#bbf7d0" stroke="currentColor" strokeWidth="1.5"/>
          <rect x="15" y="5" width="3" height="16" rx="1" fill="#bbf7d0" stroke="currentColor" strokeWidth="1.5"/>
        </svg>
      </div>
