...
const NavBar = () => {
  return (
    <div className="h-screen w-64 m-5 bg-[#4285f6] text-white flex flex-col justify-between shadow-lg rounded-xl">
      {/* Top Section */}
      <div>
        <div className="p-6 text-2xl text-center mt-5 font-bold border-blue-500">
          PRISMVIEW
        </div>
        <nav className="flex flex-col p-4 gap-4">
          <a
            href="#"
            className="flex items-center gap-3 px-2 py-2 rounded hover:bg-blue-600 transition"
          >
            <span>
              {/* Dashboard Icon */}
              <svg
      ...
      <div className="flex flex-col items-start px-6 py-10 text-sm gap-1">
        <a
          href="#"
          className="m-3 hover:underline text-gray-200 hover:text-white transition"
        >
          Help
        </a>
        <a
